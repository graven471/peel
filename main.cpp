...
// Prevent the definition of min and max macros which conflict with C++ standard libraries
#define NOMINMAX

// Exclude rarely-used features and APIs from the Windows headers to speed up compilation
...
int main(int argc, const char* argv[]) {
	...
	// i can use std::string_view here but its not guaranteed to be null terminated and since
	// most of the time file name will be < 15 chars internally it can use SSO to avoid heap
